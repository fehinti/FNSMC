...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_ABS_contDyn_model_SMC_FZL_NN_process_check_sum_call
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ABS_contDyn_model_SMC_FZL_NN_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_ABS_contDyn_model_SMC_FZL_NN_third_party_uses_info( int
  ...
  if (strcmp(machineName, "ABS_contDyn_model_SMC_FZL_NN") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ABS_contDyn_model_SMC_FZL_NN_third_party_uses_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int sf_ABS_contDyn_model_SMC_FZL_NN_jit_fallback_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "ABS_contDyn_model_SMC_FZL_NN") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ABS_contDyn_model_SMC_FZL_NN_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_post_codegen_info_call( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_ABS_contDyn_model_SMC_FZL_NN_get_post_codegen_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "ABS_contDyn_model_SMC_FZL_NN") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ABS_contDyn_model_SMC_FZL_NN_get_post_codegen_info(nlhs,plhs,3,
      newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_ABS_contDyn_model_SMC_FZL_NN_updateBuildInfo_args_info(
    int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "ABS_contDyn_model_SMC_FZL_NN") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ABS_contDyn_model_SMC_FZL_NN_updateBuildInfo_args_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_ABS_contDyn_model_SMC_FZL_NN_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "ABS_contDyn_model_SMC_FZL_NN") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ABS_contDyn_model_SMC_FZL_NN_get_eml_resolved_functions_info(nlhs,
      plhs,3,newRhs);
  }
...
extern unsigned int sf_ABS_contDyn_model_SMC_FZL_NN_method_dispatcher(SimStruct *
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"ABS_contDyn_model_SMC_FZL_NN")) {
    return(sf_ABS_contDyn_model_SMC_FZL_NN_method_dispatcher(simstructPtr,
...
extern void ABS_contDyn_model_SMC_FZL_NN_terminator(void);
void sf_machine_global_terminator(SimStruct* S)
{
  (void)S;
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    ABS_contDyn_model_SMC_FZL_NN_terminator();
  }

  return;
}

extern void ABS_contDyn_model_SMC_FZL_NN_initializer(void);
bool callCustomFcn(char initFlag)
{
  return false;
}

void sf_machine_global_initializer()
{
  sfGlobalMdlStartCallCounts++;
  if (sfGlobalMdlStartCallCounts == 1) {
    ABS_contDyn_model_SMC_FZL_NN_initializer();
  }
